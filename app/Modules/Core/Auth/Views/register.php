                                                ...
                                                <div class="form-row">
                                                      <div class="col-md-12">
                                                            <div class="position-relative form-group">
                                                                  <input name="email" placeholder="<?= lang('Auth.email') ?>" type="email" class="form-control <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" value="<?= htmlspecialchars(old('email'), ENT_QUOTES, 'UTF-8') ?>">
                                                                  <small class="form-text text-muted"><?= lang('Auth.weNeverShare') ?></small>
                                                            </div>
                                                      </div>
                                                      <div class="col-md-12">
                                                            <div class="position-relative form-group">
                                                                  <input name="username" placeholder="<?= lang('Auth.username') ?>" type="text" class="form-control <?php if (session('errors.username')) : ?>is-invalid<?php endif ?>" value="<?= htmlspecialchars(old('username'), ENT_QUOTES, 'UTF-8') ?>">
                                                            </div>
                                                      </div>
                                                      <div class="col-md-12">
                                                            <div class="position-relative form-group">
